...
const CartPage: React.FC<CartPageProps> = ({ cart, removeFromCart, updateQuantity, isRedeemingPoints, setIsRedeemingPoints }) => {
      ...
      <main className="flex-1 p-6 flex flex-col gap-6">
        {cart.length === 0 ? (
          <div className="flex flex-col items-center justify-center pt-24 px-8 text-center">
            ...
            <button onClick={() => navigate('/')} className="mt-8 text-primary text-[10px] font-black uppercase tracking-[0.3em] border border-primary/20 px-12 py-5 rounded-full active:scale-95 transition-all">Explorar Menú</button>
          </div>
        ) : (
          <>
