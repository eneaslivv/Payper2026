            ...
            <div className="flex-1 overflow-y-auto no-scrollbar px-8 pb-12">
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <button
                  ...
                  className={`flex flex-col items-center justify-center p-8 rounded-[2.5rem] transition-all gap-3 shadow-[0_15px_40px_rgba(54,226,123,0.1)] group active:scale-95 ${hasActiveOrder
